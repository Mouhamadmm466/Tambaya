#!/usr/bin/env python3
"""Seed the education knowledge base into ChromaDB.
...
Usage (from inside the backend container):
    docker exec namu_backend python scripts/seed_education_kb.py
...
COLLECTION = "education_niger"

KB_DIR = Path(__file__).parent.parent / "knowledge_base" / "education"
CHUNK_WORDS = 250
OVERLAP_WORDS = 40
BATCH_SIZE = 8
