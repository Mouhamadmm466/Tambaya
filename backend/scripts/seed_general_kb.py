#!/usr/bin/env python3
"""Seed the general knowledge base into ChromaDB.
...
Usage (from inside the backend container):
    docker exec namu_backend python scripts/seed_general_kb.py
...
COLLECTION = "general_niger"

KB_DIR = Path(__file__).parent.parent / "knowledge_base" / "general"
CHUNK_WORDS = 250
OVERLAP_WORDS = 40
BATCH_SIZE = 8
