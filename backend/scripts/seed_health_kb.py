#!/usr/bin/env python3
"""Seed the health knowledge base into ChromaDB.
...
Usage (from inside the backend container):
    docker exec namu_backend python scripts/seed_health_kb.py
...
COLLECTION = "health_niger"

KB_DIR = Path(__file__).parent.parent / "knowledge_base" / "health"
CHUNK_WORDS = 250
OVERLAP_WORDS = 40
BATCH_SIZE = 8
